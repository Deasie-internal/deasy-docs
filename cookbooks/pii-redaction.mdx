...
description: 'Detect and handle sensitive data like SSNs, emails, and phone numbers'
---

This cookbook shows you how to configure sensitive data detection (PII) in your document processing pipeline. You'll learn to identify, classify, and handle personally identifiable information for compliance requirements.
...
<CardGroup cols={2}>
  ...
  <Card title="Custom Taxonomies" icon="tags" href="/cookbooks/custom-taxonomy">
    Design complex classification schemas.
  </Card>
  ...
  <Card title="API Reference" icon="brackets-curly" href="/api-reference">
    Explore all PII-related endpoints.
  </Card>
</CardGroup>
