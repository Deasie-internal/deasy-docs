...
<Frame caption="The built-in Author tag cataloged as a Tag definition asset in the Deasy Glossary">
  <img src="/images/collibra-tag-definition.png" alt="Tag definition asset in Collibra showing the Author tag's description, max values, and group" />
</Frame>
